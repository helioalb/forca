...
Funcionalidade: Fim do jogo
  ...
  1. O jogador adivinhou todas as letras da palavra,
    então ele ganha! :)
  2. O jogador errou 6 vezez ao tentar adivinhar as letras da palavra,
    então ele perde. :(
  ...
  Cenário: Jogador vence o jogo
    Para que o jogador possa vencer o jogo, ele precisa adivinhar
    todas as letras do jogo antes que todas as partes do boneco
    da forca apareçam.
